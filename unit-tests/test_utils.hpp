#ifndef TEST_UTILS_H
#define TEST_UTILS_H
#define ASSERT_EQUAL(a, b) assert_equal_impl(__LINE__, a, b, #a, #b, false)
#define ASSERT_EQUAL_SILENT(a, b) assert_equal_impl(__LINE__, a, b, #a, #b, true)
...
template <class c> void assert_equal_impl(int line, c a, c b, const std::string &a_name, const std::string &b_name, bool silent) {
	if (a != b) {
